...
function onUpdate(mFrameTime)
	...
	s_setHueMin(color)
	s_setHueMax(color)
	s_set3dSkew("3D_skew", (math.random()/(180))*color)
	l_setRotationSpeed(math.random()*0.2)
	
	--stabilization for mashup
	l_setWallSkewLeft("wall_skew_left", 0)
	l_setWallSkewRight("wall_skew_right", 0)
	l_setWallAngleLeft("wall_angle_left", 0)
	l_setWallAngleRight("wall_angle_right", 0)
end